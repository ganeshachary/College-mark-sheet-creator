...
$titleText = "<font size=\"2px\"> <div style='margin-top:5px;padding-top:5px;' ></div></font>
...
<table width="100%" align="center" style="font-size:11px">
<tr>
<td align="left" width="20%">Programme : <b><font size="2%"> <?=$programme?></font></b> </td>
<td colspan="2" align="center"><b><font size="2%"><?=$semester?></font></b></td>
<td width="9%"  rowspan="2" align="right"><img src="<?=$val['studentPhoto']?>" width="60%" height="25%"></td>
</tr>
<tr>
<td width="10%" align="center">Examination Seat No<br><b><font size="2%"><?=$seatno?></font></b></td>
...
<!--if(!isset($resdate)) $resdate = date("d F Y"); echo $resdate;
<=($_GET['resdate'])?>-->
